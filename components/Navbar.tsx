...
function Logo() {
  ...
  return (
    <motion.a
      ...
      href="#"
      style={{ x: sx, y: sy, display: "inline-flex", alignItems: "center", gap: 10, textDecoration: "none" }}
    ...
    >
      ...
      <div>
        <span style={{
          ...
          color: "#e2e8f5", letterSpacing: "-0.03em",
        }}>
          The
          <span style={{
...
function NavLink({
  ...
  link: typeof NAV_LINKS[0]; isActive: boolean; onClick: () => void;
}) {
        ...
        <>
          ...
          >
            ...
            <div style={{
              ...
              textTransform: "uppercase", color: "#7b8bab", marginBottom: 36,
            }}>
              Navigation
            </div>
              ...
              {NAV_LINKS.map((link, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isAct && (
                      <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#60a5fa", boxShadow: "0 0 8px #3b82f6" }} />
                    )}
                  </motion.a>
                );
              })}
            ...
            >
              ...
              <p style={{ fontSize: 10, color: "#7b8bab", textAlign: "center", marginTop: 20, letterSpacing: "0.05em" }}>
                hello@yoursite.com
              </p>
            </motion.div>
          </motion.div>
  ...
  return (
    ...
    >
      <motion.span
        ...
        style={{ display: "block", width: 16, height: 1.5, background: open ? "#60a5fa" : "#7b8bab", borderRadius: 2, transformOrigin: "center" }}
      />
      <motion.span
        animate={{ opacity: open ? 0 : 1, x: open ? 8 : 0 }}
        transition={{ duration: 0.2 }}
        style={{ display: "block", width: 16, height: 1.5, background: "#7b8bab", borderRadius: 2 }}
      />
      <motion.span
        animate={{ rotate: open ? -45 : 0, y: open ? -7 : 0 }}
        transition={{ duration: 0.3, ease: [0.22,1,0.36,1] }}
...
export default function Navbar() {
  ...
  const navWidth  = scrolled ? "calc(100% - 80px)" : "100%";
  const navTop    = scrolled ? "16px" : "0px";
  const navLeft   = scrolled ? "40px" : "0px";
  const navPad    = scrolled ? "10px 24px" : "20px 40px";
        ...
        <div style={{
          ...
          <div
            style={{
              ...
              border: scrolled ? "1px solid rgba(59,130,246,0.1)" : "1px solid transparent",
              borderRadius: 99,
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div className="mobile-toggle">
              <Hamburger open={mobileOpen} onClick={() => setMobile(!mobileOpen)} />
            </div>
          </div>
        </div>

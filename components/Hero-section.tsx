...
const Hero = () => {
  ...
  // Static options array re-renders se secure karne ke liye useMemo mein wrap kiya
    ...
    <section className="relative min-h-screen bg-[#000000] flex items-center pt-20 px-6 overflow-hidden font-['Space_Grotesk',_sans-serif] before:absolute before:inset-0 before:bg-[linear-gradient(rgba(59,130,246,0.03)_1px,_transparent_1px),_linear-gradient(90deg,_rgba(59,130,246,0.03)_1px,_transparent_1px)] before:bg-[size:60px_60px] before:pointer-events-none">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-12 relative z-10">
        ...
        <div className="flex gap-10 items-center">
          <div className="hidden lg:flex flex-col gap-6 text-[#7b8bab] text-xl">
          ...
          <div>
            <motion.span
              ...
              className="bg-[#3b82f6] text-white px-4 py-[5px] text-lg font-[300] rounded-tr-xl rounded-bl-xl inline-block"
            >
              Hello, I am
            </motion.span>

            <h1 className="text-3xl md:text-[70px] font-['Syne'] font-[800] text-[#e2e8f5] mt-4 mb-2 tracking-tight leading-[1.05]">
              Muhammad Ahmed
            </h1>

            {/* ── FIX: Text Container Dimensions & Absolute Text ── */}
            {/* Height fix aur absolute positioning se layout shift aur layout recalculations stop ho jayengi */}
            <div className="h-[40px] relative flex items-center w-full overflow-hidden">
              <AnimatePresence mode="wait">
                <motion.p
                  ...
                  className="absolute text-[16px] md:text-3xl text-[#7b8bab] font-light left-0 top-0 bottom-0 flex items-center"
                >
                  {roles[index]}
                </motion.p>
              </AnimatePresence>
            ...
            <div className="mt-12 p-4 border-l-4 border-[#3b82f6] bg-[#0b0f1e]/50 backdrop-blur-sm border-blue-500/12">
              <p className="text-[#7b8bab] text-lg">
